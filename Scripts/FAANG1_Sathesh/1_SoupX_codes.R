...
## We are happy with our results and need to save our strained count matrices in a new location:
write10xCounts("SoupX/ICLN98", out, version = "3")
rm(list=ls())
...
## We are happy with our results and need to save our strained count matrices in a new location:
write10xCounts("SoupX/SP00", out, version = "3")
rm(list=ls())
...
## We are happy with our results and need to save our strained count matrices in a new location:
write10xCounts("SoupX/SP98", out, version = "3")
rm(list=ls())
...
## We are happy with our results and need to save our strained count matrices in a new location:
write10xCounts("SoupX/THY00", out, version = "3")
rm(list=ls())
...
## We are happy with our results and need to save our strained count matrices in a new location:
write10xCounts("SoupX/THY98", out, version = "3")
rm(list=ls())